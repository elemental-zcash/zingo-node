export function zingolib_wallet_exists(chain_hint: string, data_dir: string): boolean;
export function zingolib_initialize_new(server_uri: string, chain_hint: string, data_dir: string): string;
export function zingolib_initialize_existing(server_uri: string, chain_hint: string, data_dir: string): string;
